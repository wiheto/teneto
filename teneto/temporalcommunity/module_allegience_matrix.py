def module_allegience_matrix(community):
	...
	nodes i and j were assigned to the same community by time-varyin clustering methods. 
	...
	Reference:
	---------- 
	Bassett, et al. (2013) “Robust detection of dynamic community structure in networks”, 
	Chaos, 23, 1 
  ...
  C = np.unique(community)
	...
	P = (1/C)*T # module allegiance matrix, probability that ij were assigned to the same community 
